define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/angular/imperative_view/imperative_view'], function(dart_sdk, modules, disposer, imperative_view) {
  'use strict';
  ...
  dart.setMethodSignature(laminate__portal__portal.TemplatePortal, () => ({
    ...
    attach: dart.fnType(async.Future$(core.Map$(core.String, dart.dynamic)), [laminate__portal__portal.PortalHost], [core.Map$(core.String, dart.dynamic)]),
    detach: dart.fnType(async.Future, [])
  }));
  ...
  dart.setMethodSignature(laminate__portal__portal.BasePortalHost, () => ({
    ...
    setPortalDisposer: dart.fnType(dart.void, [dart.fnType(dart.void, [])])
  }));
  ...
  laminate__portal__portal.PortalHostDirective = class PortalHostDirective extends laminate__portal__portal.BasePortalHost {
    ...
    set portal(portal) {
      if (dart.test(this.hasAttached)) {
        FutureOfNull()._check(this.detach().then(core.Null, dart.fn(_ => {
          if (portal != null) {
            this.attach(portal);
          }
        }, dynamicToNull())));
  ...
  laminate__portal__portal.DomPortalHost = class DomPortalHost extends laminate__portal__portal.BasePortalHost {
    attachComponentPortal(portal) {
      ...
      return FutureOfComponentRef()._check(this[_imperativeViewUtils].insertComponent(portal.componentFactory, portal.origin, this[_hostElement]).then(src__core__linker__component_factory.ComponentRef, dart.fn(ref => {
        this.setPortalDisposer(dart.bind(ref, 'destroy'));
        return ref;
      }, ComponentRefToComponentRef())));
    }
    attachTemplatePortal(portal) {
      return FutureOfMapOfString$dynamic()._check(this[_imperativeViewUtils].insertAngularView(this[_hostElement], portal.template, portal.viewContainer).then(MapOfString$dynamic(), dart.fn(ref => {
