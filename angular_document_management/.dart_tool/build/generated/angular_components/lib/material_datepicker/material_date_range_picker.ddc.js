define(['dart_sdk', 'packages/angular_components/material_datepicker/config', 'packages/angular_components/utils/angular/css/css', 'packages/angular_components/material_datepicker/preset', 'packages/angular_components/material_datepicker/model', 'packages/angular_components/material_datepicker/comparison', 'packages/angular_components/model/observable/observable', 'packages/angular_components/model/date/date_formatter', 'packages/angular_components/model/date/date', 'packages/angular_components/src/material_datepicker/comparison_range_editor', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/material_datepicker/range', 'packages/angular_components/material_datepicker/comparison_option', 'packages/intl/intl', 'packages/angular_components/interfaces/has_disabled', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_datepicker/date_range_editor_host', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/focus/keyboard_only_focus_indicator', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular/src/core/zone/ng_zone', 'packages/angular_components/material_popup/material_popup'], function(dart_sdk, config, css, preset, model, comparison, observable, date_formatter, date, comparison_range_editor, disposer, alignment, range, comparison_option, intl, has_disabled, change_detection, date_range_editor_host, popup_hierarchy, focus_interface, keyboard_only_focus_indicator, dom_service, ng_zone, material_popup) {
  ...
  dart.defineLazy(material_datepicker__material_date_range_picker, {
    /*material_datepicker__material_date_range_picker._defaultMaxHeight*/get _defaultMaxHeight() {
      return 600;
    }
  });
  ...
  let const$;
  material_datepicker__material_date_range_picker.MaterialDateRangePickerComponent = class MaterialDateRangePickerComponent extends core.Object {
    ...
    get supportsCustomRange() {
      return this.configuration === material_datepicker__model.DateRangePickerConfiguration.fullyLoaded || this.configuration === material_datepicker__model.DateRangePickerConfiguration.basic;
    }
    get isBasic() {
      return this.configuration === material_datepicker__model.DateRangePickerConfiguration.basic;
    }
    ...
    getMaxHeight(positionY, viewportHeight) {
      let t = this[_popupSizeProvider];
      let l = t == null ? null : t.getMaxHeight(positionY, viewportHeight);
      return l != null ? l : 600;
    }
    getMaxWidth(positionX, viewportWidth) {
      let t = this[_popupSizeProvider];
      return t == null ? null : t.getMaxWidth(positionX, viewportWidth);
    }
    getMinHeight(positionY, viewportHeight) {
      let t = this[_popupSizeProvider];
      return t == null ? null : t.getMinHeight(positionY, viewportHeight);
    }
    getMinWidth(positionX, viewportWidth) {
      let t = this[_popupSizeProvider];
      return t == null ? null : t.getMinWidth(positionX, viewportWidth);
    }
    [_isPreset](cmp) {
    ...
    [_getFormattedRange](value) {
      return (value == null ? null : value.range) != null ? this.rangeFormatter(value.range) : this.placeHolderMsg;
    }
    get hasComparison() {
      return (() => {
        let t = this.selection.value;
    ...
    [_getFormattedComparison](value) {
      return this[_compareMsg](this.rangeFormatter(value == null ? null : value.comparison));
    }
  ...
  (material_datepicker__material_date_range_picker.MaterialDateRangePickerComponent.new = function(clock, legacyClock, config, popupClass, popupSizeProvider, element, domService, ngZone) {
    ...
    this[configuration] = material_datepicker__model.DateRangePickerConfiguration.fullyLoaded;
    ...
    this[rangeFormatter] = dart.fn(model__date__date_formatter.formatRange, DateRangeToString());
  ...
  const rangeFormatter = Symbol("MaterialDateRangePickerComponent.rangeFormatter");
  ...
  dart.setMethodSignature(material_datepicker__material_date_range_picker.MaterialDateRangePickerComponent, () => ({
    ...
    dateRangeEditorCreated: dart.fnType(dart.void, [focus__focus_interface.Focusable]),
  ...
  dart.setFieldSignature(material_datepicker__material_date_range_picker.MaterialDateRangePickerComponent, () => ({
    ...
    [_dateRangeEditor]: dart.fieldType(focus__focus_interface.Focusable),
    ...
    configuration: dart.fieldType(material_datepicker__model.DateRangePickerConfiguration),
    ...
    rangeFormatter: dart.fieldType(DateRangeToString()),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_date_range_picker.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA2CM,iEAAiB;YAAG;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;YA+DpB,4CAAgB,kBAAkB;;yBAIjB,MAAgC;AACnD,kBAAO,uCAAG,MAAM,MAAI,+CAAC,QAAC,KAAK,IAAK,sDAA0B,CAAC,KAAK,sDAAS;IAC3E;IAQuB;;;;;;IAMlB;;;;;;;YAQD,AAA0D,mBAA7C,KAAI,uDAA4B,YAAY,IACzD,kBAAa,KAAI,uDAA4B,MAAM;;;YAOnC,mBAAa,KAAI,uDAA4B,MAAM;;IAIlE;;;;;;IASwB;;;;;;IAQa;;;;;;2BAWnB,KAAU;AAC/B,+BAAmB,GAAG,KAAK;AAC3B,qBAAK,uBAAkB;gBAAI,cAAS,MAAM;;cAAgB,MAAM;AAC9D,sBAAS,MAAM,OACX,iEAAiC,CAAC,cAAS,MAAM,MAAM;;IAE/D;;YAE+B,0BAAmB;;4BAQ1B,KAAU;AAChC,gCAAoB,GAAG,KAAK;IAC9B;;YAEgC,2BAAoB;;2BAS7B,KAAU;AAC/B,+BAAmB,GAAG,KAAK;IAC7B;;YAE+B,0BAAmB;;gBAMtC,KAAU;AACpB,oBAAQ,GAAG,KAAK;IAClB;;YAGoB,eAAQ;;mCAUG,KAAU;AACvC,uCAA2B,GAAG,KAAK;IACrC;;cAGI,iCAA2B;6BAAI,aAAO,2BAA2B;;IAO9D;;;;;;iBAIM,KAAU;AACrB,qBAAS,GAAG,KAAK;AAEjB,oBAAI,mBAAa,eAAI,aAAQ,GAAE,UAAK;IACtC;;YAKqB,gBAAS;;gBASlB,IAAS;AACnB,oBAAQ,GAAG,IAAI;AACf,gBAAK,QAAQ,GAAG,cAAQ;IAC1B;;YAEoB,eAAQ;;gBAUhB,IAAS;AACnB,oBAAQ,GAAG,IAAI;AACf,gBAAK,QAAQ,GAAG,cAAQ;IAC1B;;YAEoB,eAAQ;;2BAML,kBAAuB;AAC5C,gBAAK,mBAAmB,GAAG,kBAAkB;IAC/C;;YAE+B,WAAK,mBAAmB;;IAIhD;;;;;;uBAIY,GAAU;AAC3B,UAAI,GAAG,IAAI,MAAM;AACjB,iCAAqB,GAAG,GAAG;IAC7B;;cAE6B,2BAAqB;6BAAI,gGAAe;;0BAQ/C,OAA8B;AAClD,UAAI,OAAO,IAAI,kBAAQ,OAAO,aAAW,GAAE;AAEzC,cAAO,AAA2B,wBAAT,IAAI,oBAAQ,wBAAkB,EAAI,OAAO;AAClE,gCAAkB,GAAG,OAAO;AAC5B,kBAAK,2BAA2B,GAAG,wBAAkB;;IAEz