define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/proto/date_range.pb', 'packages/angular_components/material_datepicker/proto/date.pb', 'packages/quiver/time', 'packages/intl/intl'], function(dart_sdk, date, date_range, date$, time, intl) {
  ...
  material_datepicker__range.MultipleDaysRange = class MultipleDaysRange extends core.Object {
    get title() {
      return this[title$];
    }
    set title(value) {
  ...
  (material_datepicker__range.MultipleDaysRange.new = function(start, lengthInDays, title) {
    this[_start] = start;
    this[_lengthInDays] = lengthInDays;
    this[title$] = title;
  }).prototype = material_datepicker__range.MultipleDaysRange.prototype;
  dart.addTypeTests(material_datepicker__range.MultipleDaysRange);
  const title$ = Symbol("MultipleDaysRange.title");
  material_datepicker__range.MultipleDaysRange[dart.implements] = () => [material_datepicker__range.DatepickerDateRange];
  dart.setMethodSignature(material_datepicker__range.MultipleDaysRange, () => ({
    __proto__: dart.getMethods(material_datepicker__range.MultipleDaysRange.__proto__),
    clamp: dart.fnType(material_datepicker__range.DatepickerDateRange, [], {min: model__date__date.Date, max: model__date__date.Date}),
    unclamped: dart.fnType(material_datepicker__range.DatepickerDateRange, []),
    asPlainRange: dart.fnType(model__date__date.DateRange, [])
  }));
  dart.setGetterSignature(material_datepicker__range.MultipleDaysRange, () => ({
    __proto__: dart.getGetters(material_datepicker__range.MultipleDaysRange.__proto__),
    start: model__date__date.Date,
    end: model__date__date.Date,
    next: material_datepicker__range.DatepickerDateRange,
    prev: material_datepicker__range.DatepickerDateRange,
  ...
  dart.setFieldSignature(material_datepicker__range.MultipleDaysRange, () => ({
    __proto__: dart.getFields(material_datepicker__range.MultipleDaysRange.__proto__),
    [_start]: dart.finalFieldType(model__date__date.Date),
    [_lengthInDays]: dart.finalFieldType(core.int),
    title: dart.finalFieldType(core.String)
  }));
  dart.defineExtensionMethods(material_datepicker__range.MultipleDaysRange, ['_equals', 'toString']);
  dart.defineExtensionAccessors(material_datepicker__range.MultipleDaysRange, ['hashCode']);
  let const$1;
  material_datepicker__range.LastNDaysRange = class LastNDaysRange extends material_datepicker__range.MultipleDaysRange {
    toProtoBuf() {
      let _ = material_datepicker__range._makeProtoBuf(this);
  ...
  (material_datepicker__range.LastNDaysRange.new = function(start, lengthInDays, title) {
    ...
    material_datepicker__range.LastNDaysRange.__proto__.new.call(this, start, lengthInDays, core.String._check((() => {
      let l = title;
  ...
  (material_datepicker__range.LastNDaysRange.beforeToday = function(clock, lengthInDays, title) {
    if (title === void 0) title = null;
    material_datepicker__range.LastNDaysRange.__proto__.new.call(this, model__date__date.Date.today(time$.Clock._check(clock)).add({days: core.int._check(dart.dsend(lengthInDays, '_negate', []))}), core.int._check(lengthInDays), core.String._check((() => {
      let l = title;
      return l != null ? l : material_datepicker__range.LastNDaysRange._lastNDaysMsg(lengthInDays);
    })()));
  }).prototype = material_datepicker__range.LastNDaysRange.prototype;
  ...
  let const$2;
  material_datepicker__range.LastNDaysToTodayRange = class LastNDaysToTodayRange extends material_datepicker__range.MultipleDaysRange {
    toProtoBuf() {
      let _ = material_datepicker__range._makeProtoBuf(this);
  ...
  (material_datepicker__range.LastNDaysToTodayRange.new = function(start, lengthInDays, title) {
    if (title === void 0) title = null;
    material_datepicker__range.LastNDaysToTodayRange.__proto__.new.call(this, start, lengthInDays, core.String._check((() => {
      let l = title;
  ...
  (material_datepicker__range.LastNDaysToTodayRange.beforeToday = function(clock, lengthInDays, title) {
    if (title === void 0) title = null;
    material_datepicker__range.LastNDaysToTodayRange.__proto__.new.call(this, model__date__date.Date.today(time$.Clock._check(clock)).add({days: core.int._check(dart.dsend(dart.dsend(lengthInDays, '-', [1]), '_negate', []))}), core.int._check(lengthInDays), core.String._check((() => {
      let l = title;
      return l != null ? l : material_datepicker__range.LastNDaysToTodayRange._lastNDaysToTodayMsg(lengthInDays);
    })()));
  }).prototype = material_datepicker__range.LastNDaysToTodayRange.prototype;
  ...
  let const$3;
  material_datepicker__range.NextNDaysFromTodayRange = class NextNDaysFromTodayRange extends material_datepicker__range.MultipleDaysRange {
    toProtoBuf() {
      let _ = material_datepicker__range._makeProtoBuf(this);
      _.nextNDaysFromToday = this[_lengthInDays];
      return _;
    }
    static _nextNDaysFromTodayMsg(lengthInDays) {
      return intl$.Intl.plural(core.int._check(lengthInDays), {one: "Today", other: dart.str(lengthInDays) + " days from today", name: "_nextNDaysFromTodayMsg", args: JSArrayOfObject().of([lengthInDays]), desc: "A date range containing the next \"lengthInDays\" days, " + "starting with today. [REL_NOTE:brockschmid/01-01-2019]", examples: const$3 || (const$3 = dart.constMap(core.String, core.Object, ["lengthInDays", 7]))});
    }
  };
  (material_datepicker__range.NextNDaysFromTodayRange.new = function(start, lengthInDays, title) {
    if (title === void 0) title = null;
    material_datepicker__range.NextNDaysFromTodayRange.__proto__.new.call(this, start, lengthInDays, core.String._check((() => {
      let l = title;
      return l != null ? l : material_datepicker__range.NextNDaysFromTodayRange._nextNDaysFromTodayMsg(lengthInDays);
    })()));
  }).prototype = material_datepicker__range.NextNDaysFromTodayRange.prototype;
  (material_datepicker__range.NextNDaysFromTodayRange.afterToday = function(clock, lengthInDays, title) {
    if (title === void 0) title = null;
    material_datepicker__range.NextNDaysFromTodayRange.__proto__.new.call(this, model__date__date.Date.today(time$.Clock._check(clock)), core.int._check(lengthInDays), core.String._check((() => {
      let l = title;
      return l != null ? l : material_datepicker__range.NextNDaysFromTodayRange._nextNDaysFromTodayMsg(lengthInDays);
    })()));
  }).prototype = material_datepicker__range.NextNDaysFromTodayRange.prototype;
  dart.addTypeTests(material_datepicker__range.NextNDaysFromTodayRange);
  dart.setMethodSignature(material_datepicker__range.NextNDaysFromTodayRange, () => ({
    __proto__: dart.getMethods(material_datepicker__range.NextNDaysFromTodayRange.__proto__),
    toProtoBuf: dart.fnType(material_datepicker__proto__date_range$46pb.DatepickerDateRange, [])
  }));
  ...
  material_datepicker__range.WeekRange = class WeekRange extends core.Object {
    ...
    static _weeksAgoMsg(weeksAgo) {
      return intl$.Intl.plural(core.int._check(weeksAgo), {zero: "This week", one: "Last week", other: dart.str(weeksAgo) + " weeks ago", name: "_weeksAgoMsg", args: JSArrayOfObject().of([weeksAgo]), desc: "A date range spanning a single week in the past.", examples: const$4 || (const$4 = dart.constMap(core.String, core.Object, ["weeksAgo", 2]))});
    }
    static _weeksFromNowMsg(weeksFromNow) {
      return intl$.Intl.plural(core.int._check(weeksFromNow), {zero: "This week", one: "Next week", other: dart.str(weeksFromNow) + " weeks from now", name: "_weeksFromNowMsg", args: JSArrayOfObject().of([weeksFromNow]), desc: "A date range spanning a single week in the future.", examples: const$5 || (const$5 = dart.constMap(core.String, core.Object, ["weeksFromNow", 2]))});
    }
  };
  ...
  material_datepicker__range.MonthRange = class MonthRange extends core.Object {
    ...
    static _monthsAgoMsg(monthsAgo) {
      return intl$.Intl.plural(core.int._check(monthsAgo), {zero: "This month", one: "Last month", other: dart.str(monthsAgo) + " months ago", name: "_monthsAgoMsg", args: JSArrayOfObject().of([monthsAgo]), desc: "A date range spanning a single month in the past.", examples: const$6 || (const$6 = dart.constMap(core.String, core.Object, ["monthsAgo", 2]))});
    }
    static _monthsFromNowMsg(monthsFromNow) {
      return intl$.Intl.plural(core.int._check(monthsFromNow), {zero: "This month", one: "Next month", other: dart.str(monthsFromNow) + " months from now", name: "_monthsFromNowMsg", args: JSArrayOfObject().of([monthsFromNow]), desc: "A date range spanning a single month in the future.", examples: const$7 || (const$7 = dart.constMap(core.String, core.Object, ["monthsFromNow", 2]))});
    }
  };
  ...
  material_datepicker__range.YearRange = class YearRange extends core.Object {
    ...
    static _yearsAgoMsg(yearsAgo) {
      return intl$.Intl.plural(core.int._check(yearsAgo), {zero: "This year", one: "Last year", other: dart.str(yearsAgo) + " years ago", name: "_yearsAgoMsg", args: JSArrayOfObject().of([yearsAgo]), desc: "A date range spanning a single year in the past.", examples: const$10 || (const$10 = dart.constMap(core.String, core.Object, ["yearsAgo", 2]))});
    }
    static _yearsFromNowMsg(yearsFromNow) {
      return intl$.Intl.plural(core.int._check(yearsFromNow), {zero: "This year", one: "Next year", other: dart.str(yearsFromNow) + " years from now", name: "_yearsFromNowMsg", args: JSArrayOfObject().of([yearsFromNow]), desc: "A date range spanning a single year in the future.", examples: const$11 || (const$11 = dart.constMap(core.String, core.Object, ["yearsFromNow", 2]))});
    }
  };
  ...
  material_datepicker__range.QuarterRange = class QuarterRange extends core.Object {
    ...
    static _quartersAgoMsg(quartersAgo) {
      return intl$.Intl.plural(core.int._check(quartersAgo), {zero: "This quarter", one: "Last quarter", other: dart.str(quartersAgo) + " quarters ago", name: "_quartersAgoMsg", args: JSArrayOfObject().of([quartersAgo]), desc: "A date range spanning a single quarter in the past.", examples: const$12 || (const$12 = dart.constMap(core.String, core.Object, ["quartersAgo", 2]))});
    }
    static _quartersFromNowMsg(quartersFromNow) {
      return intl$.Intl.plural(core.int._check(quartersFromNow), {zero: "This quarter", one: "Next quarter", other: dart.str(quartersFromNow) + " quarters from now", name: "_quartersFromNowMsg", args: JSArrayOfObject().of([quartersFromNow]), desc: "A date range spanning a single quarter in the future.", examples: const$13 || (const$13 = dart.constMap(core.String, core.Object, ["quartersFromNow", 2]))});
    }
  };
