define(['dart_sdk', 'packages/angular_components/material_input/material_number_validators', 'packages/angular_components/material_input/material_input', 'packages/angular_components/utils/angular/properties/properties', 'packages/intl/intl', 'packages/angular_components/material_input/material_input_default_value_accessor', 'packages/angular_forms/src/directives', 'packages/angular/src/core/change_detection/change_detection', 'packages/quiver/strings'], function(dart_sdk, material_number_validators, material_input, properties, intl, material_input_default_value_accessor, directives, change_detection, strings) {
  'use strict';
  ...
  material_input__material_number_accessor.MaterialNumberValueAccessor = class MaterialNumberValueAccessor extends material_input__material_input_default_value_accessor.BaseMaterialInputValueAccessor {
    static new(input, control, numberFormat, changeUpdateAttr, keypressUpdateAttr, integer, blurFormat) {
      ...
      let changeUpdate = utils__angular__properties__properties.attributeToBool(changeUpdateAttr, {defaultValue: false});
      let keypressUpdate = utils__angular__properties__properties.attributeToBool(keypressUpdateAttr, {defaultValue: false});
      ...
      let checkInteger = utils__angular__properties__properties.attributeToBool(integer, {defaultValue: false});
      return new material_input__material_number_accessor.MaterialNumberValueAccessor.__(async.Stream._check(updateStream), checkInteger, numberFormat, input, control, utils__angular__properties__properties.attributeToBool(blurFormat, {defaultValue: false}));
    }
    writeValue(newValue) {
      if (newValue == null) super.writeValue("");
      if (!core.identical(this[_parseNumber](this.input.inputText), newValue)) {
        super.writeValue(this[_numberFormat].format(newValue));
      }
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_number_accessor.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;MAqBiB,sEAA6B;YAAG,iBAC/C,6EAAqB,EACrB,6EAAmB,EACnB,oEAAsB,EACtB,mFAA2B,EAC3B,+EAAuB,EACvB,8EAAoB,EACpB,mFAAyB,EACzB,6EAAmB;;;;;;;;;eA6Bf,KAAuB,EACvB,OAAyB,EACzB,YAAqC,EACrC,gBAAkD,EAClD,kBAAsD,EACtD,OAAyC,EACzC,UAA0C;AAAE,AAC9C,UAAI;AACJ,UAAM,eAAe,sDAAe,CAAC,gBAAgB,iBAAgB;AACrE,UAAM,iBACF,sDAAe,CAAC,kBAAkB,iBAAgB;AACtD,WAAO,YAAE,YAAY,eAAI,cAAc,sBACnC;AACJ,oBAAI,YAAY,GAAE;AAChB,oBAAY,GAAG,KAAK,SAAS;YACxB,eAAI,cAAc,GAAE;AACzB,oBAAY,GAAG,KAAK,WAAW;aAC1B;AACL,oBAAY,GAAG,KAAK,OAAO;;AAE7B,0BAAY;kBAAZ,YAAY,OAAK,iCAA2B;AAC5C,UAAM,eAAe,sDAAe,CAAC,OAAO,iBAAgB;AAC5D,iBAAO,uEAA6B,qBAChC,YAAY,GACZ,YAAY,EACZ,YAAY,EACZ,KAAK,EACL,OAAO,EACP,sDAAe,CAAC,UAAU,iB