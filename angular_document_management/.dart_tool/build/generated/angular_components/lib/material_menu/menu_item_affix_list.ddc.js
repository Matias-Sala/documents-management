define(['dart_sdk', 'packages/angular_components/model/menu/menu_item_affix', 'packages/observable/observable', 'packages/angular_components/interfaces/has_disabled', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/ui/icon', 'packages/angular_components/material_menu/menu_root'], function(dart_sdk, menu_item_affix, observable, has_disabled, change_detection, icon, menu_root) {
  ...
  material_menu__menu_item_affix_list.MenuItemAffixListComponent = class MenuItemAffixListComponent extends core.Object {
    ...
    handleActionIconTrigger(icon, event) {
      ...
      if (model__menu__menu_item_affix.IconWithAction.is(icon)) {
        icon.action == null ? null : icon.action();
  ...
  dart.setGetterSignature(material_menu__menu_item_affix_list.MenuItemAffixListComponent, () => ({
    ...
    affixes: core.Iterable$(model__menu__menu_item_affix.MenuItemAffix)
  }));
