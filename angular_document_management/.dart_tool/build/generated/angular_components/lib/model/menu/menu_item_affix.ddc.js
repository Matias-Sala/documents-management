define(['dart_sdk', 'packages/angular_components/model/ui/icon'], function(dart_sdk, icon) {
  ...
  (model__menu__menu_item_affix.IconAffix.new = function(opts) {
    ...
    let cssClass = opts && 'cssClass' in opts ? opts.cssClass : null;
    this[icon$] = icon;
    this[visibility$] = visibility;
    this[cssClass$] = cssClass;
    model__menu__menu_item_affix.IconAffix.__proto__.new.call(this);
  ...
  const cssClass$ = Symbol("IconAffix.cssClass");
  ...
  dart.setGetterSignature(model__menu__menu_item_affix.IconAffix, () => ({
    ...
    shouldCloseMenuOnTrigger: core.bool
  }));
  dart.setFieldSignature(model__menu__menu_item_affix.IconAffix, () => ({
    ...
    cssClass: dart.finalFieldType(core.String)
  }));
  ...
  (model__menu__menu_item_affix.CaptionAffix.new = function(opts) {
    ...
    this[cssClass$0] = cssClass;
    model__menu__menu_item_affix.CaptionAffix.__proto__.new.call(this);
  ...
  const cssClass$0 = Symbol("CaptionAffix.cssClass");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["menu_item_affix.dart"],"names":[],"mappings":";;;;;;;;;;;YAa+B,gBAAU,KAAI,2CAAc,MAAM;;;YACzC,gBAAU,KAAI,2CAAc,OAAO;;;;EALpC;;;;;;;;IAkBJ;;;;;;IACJ;;;;;;IACH;;;;;;IAGC;;;;;;;8DAEI,IAAW,EAAE,MAAW,EAAE,SAAc,EAAE,OAAY;QAC3D,wGAA2B;IADJ,aAAM,GAAN,MAAM;IAAO,gBAAS,GAAT,SAAS;IAAO,cAAO,GAAP,OAAO;IAC3D,+BAAwB,GAAxB,wBAAwB;AAC5B,yEAAM,IAAI;EAAC;;;;;;;;;;;;;;IAMI;;;;;;IAEV;;;;;;IAGE;;;;;;;YASc,gDAAvB,SAAI,8DACH,SAAI,0BAA4C;;uBAG7B,OAAW;YACR,gDAAvB,SAAI,KAAsB,+CAAC,SAAI,SAA2B,IAAI,OAAO;;;AAIvE,0DAAI,SAAI,GAAqB;AAC7B,6DAAC,SAAI,QAA0B;;IACjC;;;QAjBoB;QACX,8DAAa,2CAAc,QAAQ;QACnC;IAFW,WAAI,GAAJ,IAAI;IACf,iBAAU,GAAV,UAAU;IACV,eAAQ,GAAR,QAAQ;;EAAE;;;;;;;;;;;;;;;;;;;;;IAqBE;;;;;;IAER;;;;;;IAGA;;;;;;;YAMwB;IAAK;uBAGlB,OAAW;YAAK;IAAK;6BAGf;;;QATpB;QAAW,8DAAa,2CAAc,QAAQ;QAAO;IAArD,WAAI,GAAJ,IAAI;IAAO,kBAAU,GAAV,UAAU;IAAgC,gBAAQ,GAAR,QAAQ;;EAAE","file":"menu_item_affix.ddc.js"}');
  // Exports:
  return {
