define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/utils/color/palette', 'packages/angular_components/scorecard/scorecard', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/scorecard/scorecard_bar', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/intl/intl'], function(dart_sdk, disposer, selection_model, palette, scorecard, change_detection, scorecard_bar, dom_service, intl) {
  'use strict';
  ...
  let IterableOfHtmlElement = () => (IterableOfHtmlElement = dart.constFn(core.Iterable$(html.HtmlElement)))();
  ...
  scorecard__scoreboard.ScoreboardComponent = class ScoreboardComponent extends core.Object {
    ...
    ngOnInit() {
      switch (this.type) {
        ...
        {
          this[_selectionModel] = model__selection__selection_model.SelectionModel.single();
          break;
        }
        case scorecard__scoreboard.ScoreboardType.selectable:
        {
          this[_selectionModel] = model__selection__selection_model.SelectionModel.multi();
          break;
        }
        default:
        {
          this[_selectionModel] = model__selection__selection_model.SelectionModel.empty();
          break;
        }
      }
    ...
    [_makeScorecardsUniformWidth]() {
      let scorecardsElem = IterableOfHtmlElement()._check(this[_scorecards][$map](html.HtmlElement, dart.fn(scorecard => scorecard.element, ScorecardComponentToHtmlElement())))[$toList]();
      let width = 0.0;
  ...
  dart.setGetterSignature(scorecard__scoreboard.ScoreboardComponent, () => ({
    ...
    isScrollable: core.bool,
    atScorecardBarStart: core.bool,
    atScorecardBarEnd: core.bool,
    backIconType: core.String,
    forwardIconType: core.String
  }));
  dart.setSetterSignature(scorecard__scoreboard.ScoreboardComponent, () => ({
    ...
    scoreCards: core.List$(scorecard__scorecard.ScorecardComponent),
    scorecardBar: scorecard__scorecard_bar.ScorecardBarDirective
  }));
  dart.setFieldSignature(scorecard__scoreboard.ScoreboardComponent, () => ({
    ...
    [_scorecardBar]: dart.fieldType(scorecard__scorecard_bar.ScorecardBarDirective),
  ...
  dart.defineLazy(scorecard__scoreboard.ScoreboardComponent, {
    ...
    /*scorecard__scoreboard.ScoreboardComponent.scrollScorecardBarForward*/get scrollScorecardBarForward() {
    ...
    /*scorecard__scoreboard.ScoreboardComponent.scrollScorecardBarBack*/get scrollScorecardBarBack() {
