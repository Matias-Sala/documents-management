define(['dart_sdk', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular/src/core/zone/ng_zone', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular_components/utils/browser/events/events', 'packages/quiver/core', 'packages/angular_components/utils/angular/scroll_host/interface', 'packages/logging/logging'], function(dart_sdk, scroll_host_interface, async_update_scheduler, ng_zone, dom_service, disposer, feature_detector, events, core, $interface, logging) {
  ...
  dart.setGetterSignature(src__utils__angular__scroll_host__position_sticky_controller.PositionStickyController, () => ({
    ...
    onUpdate: async.Stream$(core$.Null),
  ...
  const _scrollHost$ = Symbol('_scrollHost');
  const _onUpdateController = Symbol('_onUpdateController');
  ...
  src__utils__angular__scroll_host__sticky_controller_impl.StickyControllerImpl = class StickyControllerImpl extends core$.Object {
    ...
    get onUpdate() {
      let t = this[_onUpdateController];
      t == null ? this[_onUpdateController] = StreamControllerOfNull().broadcast({sync: true}) : t;
    ...
    [_checkAndUpdateLayout]() {
      ...
      if (!dart.equals(layout, this[_currentLayout]) && this[_orderedRows] != null) {
        ...
        if ((() => {
          let t = this[_onUpdateController];
          let l = t == null ? null : t.hasListener;
  ...
  dart.setGetterSignature(src__utils__angular__scroll_host__sticky_controller_impl.StickyControllerImpl, () => ({
    __proto__: dart.getGetters(src__utils__angular__scroll_host__sticky_controller_impl.StickyControllerImpl.__proto__),
    onUpdate: async.Stream$(core$.Null)
  }));
  dart.setFieldSignature(src__utils__angular__scroll_host__sticky_controller_impl.StickyControllerImpl, () => ({
    ...
    [_scrollHost$]: dart.finalFieldType(src__utils__angular__scroll_host__scroll_host_interface.ScrollHost),
    [_onUpdateController]: dart.fieldType(StreamControllerOfNull()),
    usePositionSticky: dart.finalFieldType(core$.bool),
  ...
  src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase = class ScrollHostBase extends core$.Object {
    ...
    get onScroll() {
      if (this[_onScrollStream] == null) {
        ...
        this[_onScrollStream] = new (ZonedStreamOfScrollHostEvent()).new(this[_onScrollController].stream, dart.gbind(dart.bind(this[_ngZone], 'runOutsideAngular'), dart.dynamic));
      }
      ...
      if (!dart.test(this.usePositionSticky)) {
        this[_elementListenersDisposer].addStreamSubscription(html.WheelEvent, this.anchorElement[$onMouseWheel].listen(dart.fn(event => {
          ...
          try {
            deltaX = event[$deltaX];
            if (deltaX == null) {
              src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase._logger.severe("deltaX is null in event: " + dart.str(event));
            }
          } catch (e) {
            let error = dart.getThrown(e);
            if (core$.UnsupportedError.is(error)) {
              src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase._logger.severe("deltaX is not supported in event: " + dart.str(event), error);
            } else
              throw e;
          }
          let t = deltaX;
          ...
          try {
            deltaY = event[$deltaY];
            if (deltaY == null) {
              src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase._logger.severe("deltaY is null in event: " + dart.str(event));
            }
          } catch (e$) {
            let error = dart.getThrown(e$);
            if (core$.UnsupportedError.is(error)) {
              src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase._logger.severe("deltaY is not supported in event: " + dart.str(event), error);
            } else
              throw e$;
          }
          let t$ = deltaY;
          t$ == null ? deltaY = 0 : t$;
          let d = src__utils__angular__scroll_host__gestures.scrollDirection(deltaX, -dart.notNull(deltaY));
  ...
  dart.defineLazy(src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase, {
    /*src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase._logger*/get _logger() {
      return logging$.Logger.new("ScrollHostBase");
    }
  });
