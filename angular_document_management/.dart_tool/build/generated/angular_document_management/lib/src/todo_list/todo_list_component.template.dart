...
import 'package:angular_document_management/src/todo_list/todo_list_component.css.shim.dart' as import0;
...
class ViewTodoListComponent0 extends AppView<import2.TodoListComponent> {
  ...
  bool _expr_3;
  bool _expr_6 = false;
  import14.Comment _anchor_4;
  import14.Element _el_4_0;
  ...
  ViewTodoListComponent0(AppView<dynamic> parentView, int parentIndex) : super(import16.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    rootEl = import14.document.createElement('todo-list');
    _renderType ??= import18.appViewUtils.createRenderType((import19.isDevMode ? 'asset:angular_document_management/lib/src/todo_list/todo_list_component.dart' : null), ViewEncapsulation.Emulated, styles$TodoListComponent);
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, const import22.MultiToken<dynamic>('NgValidators')) && (1 == nodeIndex))) {
    ...
    if (((((identical(token, import6.MaterialInputComponent) || identical(token, import24.ReferenceDirective)) || identical(token, import25.Focusable)) || identical(token, import26.HasDisabled)) && (1 == nodeIndex))) {
  ...
  void detectChangesInternal() {
    ...
    if (import18.checkBinding(_expr_6, currVal_6)) {
      if (currVal_6) {
        ...
        addShimE(_el_4_0);
        final _text_4_1 = import14.Text('Nothing to do! Add items above.');
...
class _ViewTodoListComponent3 extends AppView<import2.TodoListComponent> {
  ...
  bool _expr_0;
  var _expr_1;
  import14.Element _el_2;
  import14.Text _text_3;
  ...
  void detectChangesInternal() {
    ...
    final local_item = import19.unsafeCast<String>(locals['\$implicit']);
    changed = false;
    if (changed) {
      _compView_1.markAsCheckOnce();
    }
  ...
  void _handle_trigger_4_0($event) {
    final local_i = import19.unsafeCast<int>(locals['index']);
    ctx.remove(local_i);
  }
}
