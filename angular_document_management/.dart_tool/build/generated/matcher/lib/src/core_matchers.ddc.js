define(['dart_sdk', 'packages/stack_trace/stack_trace'], function(dart_sdk, stack_trace) {
  ...
  let IterableOfMatcher = () => (IterableOfMatcher = dart.constFn(core.Iterable$(src__interfaces.Matcher)))();
  ...
  dart.defineLazy(src__util, {
    ...
    /*src__util._escapeRegExp*/get _escapeRegExp() {
      return core.RegExp.new("[\\x00-\\x07\\x0E-\\x1F" + dart.str(IterableOfString()._check(src__util._escapeMap[$keys][$map](core.String, dart.fn(src__util._getHexLiteral, StringToString())))[$join]()) + "]");
    }
  });
  ...
  src__pretty_print.prettyPrint = function(object, opts) {
    ...
    function _prettyPrint(object, indent, seen, top) {
      ...
      if (core.Iterable.is(object)) {
        ...
        let strings = IterableOfString()._check(object[$map](core.String, pp))[$toList]();
        ...
        return type + "[\n" + dart.notNull(IterableOfString()._check(strings[$map](core.String, dart.fn(string => dart.notNull(src__pretty_print._indent(dart.notNull(indent) + 2)) + dart.notNull(string), StringToString())))[$join](",\n")) + "\n" + dart.notNull(src__pretty_print._indent(indent)) + "]";
      } else if (core.Map.is(object)) {
        let strings = IterableOfString()._check(object[$keys][$map](core.String, dart.fn(key => dart.str(pp(key)) + ": " + dart.str(pp(object[$_get](key))), dynamicToString())))[$toList]();
        if (maxItems != null && dart.notNull(strings[$length]) > dart.notNull(maxItems)) {
          strings[$replaceRange](dart.notNull(maxItems) - 1, strings[$length], JSArrayOfString().of(["..."]));
        }
        ...
        return "'" + dart.notNull(IterableOfString()._check(lines[$map](core.String, dart.fn(src__pretty_print._escapeString, StringToString())))[$join]("\\n'\n" + dart.str(src__pretty_print._indent(dart.notNull(indent) + 2)) + "'")) + "'";
      } else {
  ...
  (src__iterable_matchers._UnorderedMatches.new = function(expected, opts) {
    ...
    this[_expected$0] = IterableOfMatcher()._check(expected[$map](src__interfaces.Matcher, dart.fn(src__util.wrapMatcher, dynamicToMatcher())))[$toList]();
    let l = allowUnmatchedValues;
    this[_allowUnmatchedValues] = l != null ? l : false;
  ...
  src__iterable_matchers._ContainsAllInOrder = class _ContainsAllInOrder extends src__iterable_matchers._IterableMatcher {
    [_test](item, matchState) {
      let matchers = IterableOfMatcher()._check(this[_expected$0][$map](src__interfaces.Matcher, dart.fn(src__util.wrapMatcher, dynamicToMatcher())))[$toList]();
      let matcherIndex = 0;
  ...
  src__operator_matchers._wrapArgs = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    ...
    return IterableOfMatcher()._check(args[$map](src__interfaces.Matcher, dart.fn(src__util.wrapMatcher, dynamicToMatcher())))[$toList]();
  };
