define(['dart_sdk', 'packages/http/http', 'packages/package_config/packages_file', 'packages/path/path', 'packages/collection/collection'], function(dart_sdk, http, packages_file, path, collection) {
  ...
  const src__utils_io_stub = Object.create(_root);
  const src__utils_isolate_stub = Object.create(_root);
  const src__utils = Object.create(_root);
  const src__current_isolate_resolver_stub = Object.create(_root);
  ...
  src__utils_io_stub.readFileAsString = function(uri) {
    return dart.throw(new core.UnsupportedError.new("Reading files is only supported where dart:io is available."));
  };
  src__utils_io_stub.packagePathForRoot = function(package$, root) {
  ...
  src__utils_isolate_stub.resolvePackageUri = function(packageUri) {
  ...
  src__utils.loadConfigMap = function(uri, opts) {
    return async.async(MapOfString$Uri(), function* loadConfigMap() {
      ...
      if (resolved.scheme === "http") {
        ...
        text = (yield src__utils_io_stub.readFileAsString(resolved));
      } else if (resolved.scheme === "data") {
        text = resolved.data.contentAsString();
      } else if (resolved.scheme === "package") {
        return src__utils.loadConfigMap(yield src__utils_isolate_stub.resolvePackageUri(uri), {client: client});
      } else {
  ...
  src__utils.packagePathForRoot = function(package$, root) {
    return src__utils_io_stub.packagePathForRoot(package$, root);
  };
  src__current_isolate_resolver_stub.currentIsolateResolver = function() {
  ...
  dart.defineLazy(src__package_resolver.PackageResolver, {
    /*src__package_resolver.PackageResolver.current*/get current() {
      return src__current_isolate_resolver_stub.currentIsolateResolver();
    },
  ...
  dart.trackLibraries("packages/package_resolver/package_resolver.ddc", {
    ...
    "package:package_resolver/src/utils_io_stub.dart": src__utils_io_stub,
    "package:package_resolver/src/utils_isolate_stub.dart": src__utils_isolate_stub,
    "package:package_resolver/src/utils.dart": src__utils,
    "package:package_resolver/src/current_isolate_resolver_stub.dart": src__current_isolate_resolver_stub,
