define(['dart_sdk', 'packages/async/async', 'packages/stack_trace/stack_trace'], function(dart_sdk, async, stack_trace) {
  ...
  let IterableOfFutureOfvoid = () => (IterableOfFutureOfvoid = dart.constFn(core.Iterable$(FutureOfvoid())))();
  ...
  pool.Pool = class Pool extends core.Object {
    ...
    forEach(S, T, elements, action, opts) {
      ...
      const onListen = (function() {
        ...
        doneFuture = async$.Future.wait(dart.void, IterableOfFutureOfvoid()._check(IterableOfint().generate(this[_maxAllocatedResources])[$map](FutureOfvoid(), dart.fn(i => this.withResource(dart.void, dart.fn(() => run(i), VoidToFutureOfvoid())), intToFutureOfvoid()))), {eagerError: true}).catchError(dart.bind(controller, 'addError'));
    ...
    [_runOnRelease](onRelease) {
      FutureOfNull()._check(async$.Future.sync(onRelease).then(core.Null, dart.fn(value => {
