define(['dart_sdk', 'packages/quiver/core', 'packages/quiver/iterables'], function(dart_sdk, core, iterables) {
  ...
  collection$.HashBiMap$ = dart.generic((K, V) => {
    ...
    class HashBiMap extends core$.Object {
      ...
      get inverse() {
        let t = this[_cached];
        return t == null ? this[_cached] = new (HashBiMapOfV$K())._from(this[_inverse], this[_map]) : t;
      }
      addEntries(entries) {
  ...
  collection$.LinkedLruHashMap$ = dart.generic((K, V) => {
    ...
    class LinkedLruHashMap extends core$.Object {
      ...
      addEntries(entries) {
        IterableOfMapEntryOfK$V()._check(entries);
        return entries[$forEach](dart.fn(entry => this._set(entry.key, entry.value), MapEntryOfK$VToV()));
      }
      cast(K2, V2) {
        dart.throw(new core$.UnimplementedError.new("cast"));
      }
      ...
      get entries() {
        return IterableOfMapEntryOfK$V()._check(this[_entries][$values][$map](MapEntryOfK$V(), dart.fn(entry => MapEntryOfK$V().new(entry.key, entry.value), _LinkedEntryOfK$VToMapEntryOfK$V())));
      }
      forEach(action) {
        let head = this[_head];
        while (head != null) {
      ...
      get keys() {
        return IterableOfK()._check(this[_iterable]()[$map](K, dart.fn(e => e.key, _LinkedEntryOfK$VToK())));
      }
      get values() {
        return IterableOfV()._check(this[_iterable]()[$map](V, dart.fn(e => e.value, _LinkedEntryOfK$VToV())));
      }
      map(K2, V2, transform) {
      ...
      remove(key) {
        ...
        if (entry != null) {
          if (dart.equals(entry, this[_head]) && dart.equals(entry, this[_tail])) {
            ...
            let l = this[_head];
            l == null ? null : l.previous = null;
          } else if (dart.equals(entry, this[_tail])) {
            this[_tail] = this[_tail].previous;
            let l$ = this[_tail];
            l$ == null ? null : l$.next = null;
          } else {
  ...
  collection$._BaseMultimap$ = dart.generic((K, V, C) => {
    ...
    class _BaseMultimap extends core$.Object {
      ...
      get values() {
        return IterableOfV()._check(this[_map][$values][$expand](V, dart.fn(x => x, CToC())));
      }
      get [_groupedValues]() {
    ...
    (_BaseMultimap.fromIterable = function(iterable, opts) {
      ...
      this[_map] = new (LinkedMapOfK$C()).new();
      let t = key;
      t == null ? key = dart.gbind(dart.fn(collection$._BaseMultimap._id, dynamicToT()), K) : t;
      let t$ = value;
      t$ == null ? value = dart.gbind(dart.fn(collection$._BaseMultimap._id, dynamicToT()), V) : t$;
  ...
  collection$._WrappedMap$ = dart.generic((K, V, C) => {
    ...
    class _WrappedMap extends core$.Object {
      ...
      map(K2, C2, transform) {
        return core$.Map$(K2, C2)._check(this[_multimap][_map][$map](K2, C2, transform));
      }
      update(key, update, opts) {
        K._check(key);
        CToC()._check(update);
  ...
  collection$.DelegatingIterable$ = dart.generic(E => {
    ...
    class DelegatingIterable extends core$.Object {
      ...
      expand(T, f) {
        return core$.Iterable$(T)._check(this.delegate[$expand](T, f));
      }
      get first() {
      ...
      fold(T, initialValue, combine) {
        return T._check(this.delegate[$fold](T, initialValue, combine));
      }
      followedBy(other) {
      ...
      map(T, f) {
        return core$.Iterable$(T)._check(this.delegate[$map](T, f));
      }
      reduce(combine) {
  ...
  collection$.DelegatingMap$ = dart.generic((K, V) => {
    ...
    dart.setMethodSignature(DelegatingMap, () => ({
      ...
      addAll: dart.fnType(dart.void, [core$.Object]),
      [$addAll]: dart.fnType(dart.void, [core$.Object]),
      addEntries: dart.fnType(dart.void, [core$.Iterable$(core$.Object)]),
      [$addEntries]: dart.fnType(dart.void, [core$.Iterable$(core$.Object)]),
      cast: dart.gFnType((K2, V2) => [core$.Map$(K2, V2), []]),
      [$cast]: dart.gFnType((K2, V2) => [core$.Map$(K2, V2), []]),
      clear: dart.fnType(dart.void, []),
