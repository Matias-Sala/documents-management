define(['dart_sdk'], function(dart_sdk) {
  ...
  iterables$.concat = function(T, iterables) {
    return core.Iterable$(T)._check(iterables[$expand](T, dart.fn(x => x, dart.fnType(core.Iterable$(T), [core.Iterable$(T)]))));
  };
  ...
  iterables$.InfiniteIterable$ = dart.generic(T => {
    ...
    dart.setMethodSignature(InfiniteIterable, () => ({
      ...
      lastWhere: dart.fnType(T, [dart.fnType(core.bool, [T])], {orElse: core.Object}),
      [$lastWhere]: dart.fnType(T, [dart.fnType(core.bool, [T])], {orElse: core.Object}),
      reduce: dart.fnType(T, [core.Object]),
      [$reduce]: dart.fnType(T, [core.Object]),
      singleWhere: dart.fnType(T, [dart.fnType(core.bool, [T])], {orElse: core.Object}),
      [$singleWhere]: dart.fnType(T, [dart.fnType(core.bool, [T])], {orElse: core.Object})
    }));
  ...
  iterables$.EnumerateIterable$ = dart.generic(V => {
    ...
    dart.setGetterSignature(EnumerateIterable, () => ({
      ...
      isEmpty: core.bool,
      [$isEmpty]: core.bool,
      first: iterables$.IndexedValue$(V),
      [$first]: iterables$.IndexedValue$(V),
      last: iterables$.IndexedValue$(V),
      [$last]: iterables$.IndexedValue$(V),
      single: iterables$.IndexedValue$(V),
      [$single]: iterables$.IndexedValue$(V)
    }));
  ...
  iterables$.merge = function(T, iterables, compare) {
    ...
    if (dart.test(iterables[$isEmpty])) return const$ || (const$ = dart.constList([], core.Null));
    if (dart.test(iterables[$every](dart.fn(i => i[$isEmpty], dart.fnType(core.bool, [core.Iterable$(T)]))))) return const$0 || (const$0 = dart.constList([], core.Null));
    return new (iterables$._Merge$(T)).new(iterables, dart.fnType(core.int, [T, T])._check(compare != null ? compare : dart.fn(core.Comparable.compare, ComparableAndComparableToint())));
  };
  ...
  iterables$._Merge$ = dart.generic(T => {
    ...
    class _Merge extends collection.IterableBase$(T) {
      get iterator() {
        return new (_MergeIteratorOfT()).new(IterableOfIteratorOfT()._check(this[_iterables][$map](IteratorOfT(), dart.fn(i => i[$iterator], IterableOfTToIteratorOfT())))[$toList]({growable: false}), this[_compare]);
      }
      toString() {
  ...
  iterables$._MergeIterator$ = dart.generic(T => {
    ...
    let IterableOf_IteratorPeekerOfT = () => (IterableOf_IteratorPeekerOfT = dart.constFn(core.Iterable$(_IteratorPeekerOfT())))();
    ...
    (_MergeIterator.new = function(iterators, compare) {
      this[_current] = null;
      this[_compare] = compare;
      this[_peekers] = IterableOf_IteratorPeekerOfT()._check(iterators[$map](_IteratorPeekerOfT(), dart.fn(i => new (_IteratorPeekerOfT()).new(i), IteratorOfTTo_IteratorPeekerOfT())))[$toList]();
  ...
  iterables$.max = function(T, i, compare) {
    ...
    let _compare = dart.fnType(core.int, [T, T])._check(compare != null ? compare : dart.fn(core.Comparable.compare, ComparableAndComparableToint()));
  ...
  iterables$.partition = function(T, iterable, size) {
  ...
  iterables$._Partition$ = dart.generic(T => {
    ...
    (_Partition.new = function(iterable, size) {
      this[_iterable$] = iterable;
      this[_size] = size;
  ...
  iterables$._PartitionIterator$ = dart.generic(T => {
    ...
    (_PartitionIterator.new = function(iterator, size) {
      this[_current] = null;
      this[_iterator] = iterator;
      this[_size] = size;
    ...
    _PartitionIterator[dart.implements] = () => [IteratorOfListOfT()];
  ...
  iterables$.zip = function(T, iterables) {
    return new (_js_helper.SyncIterable$(core.List$(T))).new(function* zip() {
      ...
      let iterators = core.Iterable$(core.Iterator$(T))._check(iterables[$map](core.Iterator$(T), dart.fn(e => e[$iterator], dart.fnType(core.Iterator$(T), [core.Iterable$(T)]))))[$toList]({growable: false});
      while (dart.test(iterators[$every](dart.fn(e => e.moveNext(), dart.fnType(core.bool, [core.Iterator$(T)]))))) {
        yield core.Iterable$(T)._check(iterators[$map](T, dart.fn(e => e.current, dart.fnType(T, [core.Iterator$(T)]))))[$toList]({growable: false});
      }
    });
  };
  dart.trackLibraries("packages/quiver/iterables.ddc", {
    "package:quiver/iterables.dart": iterables$
  }, '{"version":3,"sourceRoot":"","sources":["src/iterables/concat.dart","src/iterables/count.dart","src/iterables/infinite_iterable.dart","src/iterables/cycle.dart","src/iterables/enumerate.dart","src/iterables/merge.dart","src/iterables/min_max.dart","src/iterables/partition.dart","src/iterables/generating_iterable.dart","src/iterables/range.dart","src/iterables/zip.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;kCAmBsB,SAA+B;oCACjD,SAAS,SAAO,IAAC,QAAC,CAAC,IAAK,CAAC;EAAC;8BCFT,KAAa,EAAE,IAAY;0BAAvB,QAAQ;yBAAO,OAAO;UAAO,KAAI,qBAAM,CAAC,KAAK,EAAE,IAAI;EAAC;;;;;;;cCEvD;MAAK;;cAEF;MAAI;;cAEb,YAAM,IAAI,yBAAgB,CAAC;MAAO;;cAE9B,YAAM,IAAI,yBAAgB,CAAC;MAAS;;cAEtC,YAAM,IAAI,mBAAU,CAAC;MAAS;YAEnC,CAAiB;cAAK,YAAM,IAAI,yBAAgB,CAAC;MAAQ;eAExD,YAAe,EAAE,OAAuC;cAChE,YAAM,IAAI,yBAAgB,CAAC;MAAO;cAEzB,CAAiB;cAAK,YAAM,IAAI,yBAAgB,CAAC;MAAU;WAE3D,SAAqB;kCAAd,YAAY;cAAQ,YAAM,IAAI,yBAAgB,CAAC;MAAO;gBAE9D,IAAkB;YAAK;;cAC/B,YAAM,IAAI,yBAAgB,CAAC;MAAY;aAElC,OAA6B;0BAA3B;cACP,YAAM,IAAI,yBAAgB,CAAC;MAAS;kBAE1B,IAAkB;YAAK;;cACjC,YAAM,IAAI,yBAAgB,CAAC;MAAc;;YAExB,wDAAU;cAAU,YAAM,IAAI,yBAAgB,CAAC;MAAS;;cAE3D,YAAM,IAAI,yBAAgB,CAAC;MAAQ;;;;IACvD;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;YD1BgC,KAAI,6BAAc,CAAC,UAAK,EAAE,SAAI;IAAC;;oCAFtD,KAAc,EAAE,IAAa;IAApB,UAAK,GAAL,KAAK;IAAW,SAAI,GAAJ,IAAI;;EAAC;;;;;;;;;;;;;;;;;;YAclB,eAAQ;;;AAGzB,oBAAQ,GAAG,AAAC,cAAQ,IAAI,OAAQ,YAAM,GAAY,aAAT,cAAQ,iBAAG,WAAK;AACzD,YAAO;IACT;;;IATI,cAAQ;IAEY,YAAM;IAAO,WAAK;EAAC;;;;;;;;;;;;;;;;;iCEjBxB,QAAoB;UAAK,KAAI,2BAAS,CAAC,QAAQ;EAAC;;;;;;;;cAOvC,KAAI,yBAAc,CAAC,gBAAS;MAAC;;cAErC,iBAAS,UAAQ;;;cAEd,iBAAS,aAAW;;;;MAN/B,gBAAS;;IAAC;;;;;;;;;;;;;;;;;;;;;;;;cAmBL,
;;;;;;;;;;;;;;;;;;;cAcuB,eAAQ;;;AAI7B,YAAI,WAAW;AACf,YAAI,QAAQ;AACZ,eAAO,AAAM,KAAD,gBAAG,WAAK,eAAI,eAAS,SAAS,KAAI;AAC5C,kBAAQ,MAAI,CAAC,eAAS,QAAQ;AAC9B,eAAK;;AAEP,sBAAQ,GAAG,AAAC,AAAM,KAAD,GAAG,IAAK,QAAQ,GAAG;AACpC,cAAO,eAAQ,IAAI;MACrB;;;MAjBQ,cAAQ;MAEQ,eAAS;MAAO,WAAK;IAAC;;;;;;;;;;;;;;;;;;;;;;iCCnB9B,OAAS,EAAE,IAAO;UAAK,KAAI,iCAAkB,CAAC,OAAO,EAAE,IAAI;EAAC;;;;;;;MA4B1D;;;;;;MACH;;;;;;;cAKa,KAAI,8BAAmB,CAAC,YAAO,IAAI,SAAI;MAAC;;uCAHjD,OAAY,EAAE,IAAS;MAAlB,cAAO,GAAP,OAAO;MAAO,WAAI,GAAJ,IAAI;;IAAC;;;;;;;;;;;;;;;;;;;;;;;;;;yBAc1B,YAAO,IAAG,WAAM,GAAG;MAAI;;AAItC,YAAI,WAAM,IAAI,MAAM,MAAO;AAC3B,sBAAI,YAAO,GAAE;AACX,qBAAM,GAAG,SAAI,CAAC,WAAM;eACf;AACL,sBAAO,GAAG;;AAEZ,cAAO,YAAM,IAAI;MACnB;;wCAdoB,MAAa,EAAE,IAAS;MAFvC,YAAO,GAAG;MAEY,WAAM,GAAN,MAAM;MAAO,SAAI,GAAJ,IAAI;IAAC;;;;;;;;;;;;;;;;;;;;;;8BClC3B,aAAiB,EAAG,IAAQ,EAAE,IAAQ;AAAG,gEAArB,IAAQ,EAAE,IAAQ;2BAAd;2BAAU;AACpD,UAAM,QAAQ,IAAI,IAAI,OAAO,IAAI,aAAa;AAC9C,kBAAI;kBAAJ,IAAI,GAAK,aAAa;AACtB,mBAAI;mBAAJ,IAAI,GAAK;AAET,UAAI,IAAI,KAAI,GAAG,WAAM,IAAI,sBAAa,CAAC;AACvC,UAAS,aAAL,IAAI,IAAG,KAAU,aAAL,IAAI,iBAAG,KAAK,GAC1B,WAAM,IAAI,sBAAa,CAAC,yBACpB;AACN,UAAS,aAAL,IAAI,IAAG,KAAU,aAAL,IAAI,iBAAG,KAAK,GAC1B,WAAM,IAAI,sBAAa,CAAC,yBACpB;AAEN,eAAS,QAAQ,KAAK,EAAE,AAAK,aAAL,IAAI,IAAG,IAAU,aAAN,KAAK,iBAAG,IAAI,IAAS,aAAN,KAAK,iBAAG,IAAI,GAAE,KAAK,GAxCvE,aAwCkE,KAAK,iBAAI,IAAI;AAC3E,cAAM,KAAK;IACf,GAfwC,IAAQ,EAAE,IAAQ;EAe1D;+BCtByB,SAA+B;AAAE;AACxD,oBAAI,SAAS,UAAQ,GAAE;AACvB,UAAM,qDAAY,SAAS,MAAI,oBAAC,QAAC,CAAC,IAAK,CAAC,WAAS,iEAAQ,YAAW;AACpE,uBAAO,SAAS,QAAM,CAAC,QAAC,CAAC,IAAK,CAAC,SAAS,oDAAK;AAC3C,uCAAM,SAAS,MAAI,IAAC,QAAC,CAAC,IAAK,CAAC,QAAQ,iDAAQ,YAAW;;IAE3D","file":"iterables.ddc.js"}');
  // Exports:
  return {
    iterables: iterables$
  };
