define(['dart_sdk', 'packages/package_resolver/package_resolver', 'packages/stack_trace/stack_trace', 'packages/path/path'], function(dart_sdk, package_resolver, stack_trace, path) {
  ...
  let IterableOfTrace = () => (IterableOfTrace = dart.constFn(core.Iterable$(src__trace.Trace)))();
  ...
  let IterableOfFrame = () => (IterableOfFrame = dart.constFn(core.Iterable$(src__frame.Frame)))();
  ...
  source_map_stack_trace.mapStackTrace = function(sourceMap, stackTrace, opts) {
    ...
    if (src__chain.Chain.is(stackTrace)) {
      return new src__chain.Chain.new(IterableOfTrace()._check(stackTrace.traces[$map](src__trace.Trace, dart.fn(trace => src__trace.Trace.from(source_map_stack_trace.mapStackTrace(sourceMap, trace, {minified: minified, packageResolver: packageResolver, sdkRoot: sdkRoot})), TraceToTrace()))));
    }
    ...
    return new src__trace.Trace.new(IterableOfFrame()._check(trace.frames[$map](src__frame.Frame, dart.fn(frame => {
