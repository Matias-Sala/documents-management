define(['dart_sdk', 'packages/source_maps/src/source_map_span', 'packages/source_span/source_span'], function(dart_sdk, source_map_span, source_span) {
  ...
  let IterableOfSourceFile = () => (IterableOfSourceFile = dart.constFn(core.Iterable$(src__file.SourceFile)))();
  ...
  parser.MappingBundle = class MappingBundle extends parser.Mapping {
    ...
    toJson() {
      return IterableOfMap()._check(this[_mappings][$values][$map](core.Map, dart.fn(v => v.toJson(), SingleMappingToMap())))[$toList]();
    }
    toString() {
  ...
  parser.SingleMapping = class SingleMapping extends parser.Mapping {
    ...
    static fromEntries(entries, fileUrl) {
      ...
      return new parser.SingleMapping.__(fileUrl, IterableOfSourceFile()._check(urls[$values][$map](src__file.SourceFile, dart.fn(i => files[$_get](i), intToSourceFile())))[$toList](), urls[$keys][$toList](), names[$keys][$toList](), lines);
    }
    toJson(opts) {
      ...
      if (dart.test(includeSourceContents)) {
        result[$_set]("sourcesContent", IterableOfString()._check(this.files[$map](core.String, dart.fn(file => {
