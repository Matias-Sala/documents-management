define(['dart_sdk', 'packages/async/async', 'packages/stream_channel/stream_channel', 'packages/path/path', 'packages/string_scanner/string_scanner', 'packages/collection/collection', 'packages/term_glyph/term_glyph', 'packages/matcher/src/core_matchers', 'packages/boolean_selector/boolean_selector', 'packages/source_span/source_span', 'packages/collection/src/canonicalized_map', 'packages/stack_trace/stack_trace', 'packages/pedantic/pedantic'], function(dart_sdk, async, stream_channel, path, string_scanner, collection, term_glyph, core_matchers, boolean_selector, source_span, canonicalized_map, stack_trace, pedantic) {
  ...
  let IterableOfGroupEntry = () => (IterableOfGroupEntry = dart.constFn(core.Iterable$(src__backend__group_entry.GroupEntry)))();
  ...
  let IterableOfStreamMatcher = () => (IterableOfStreamMatcher = dart.constFn(core.Iterable$(src__frontend__stream_matcher.StreamMatcher)))();
  ...
  let IterableOfFutureOfNull = () => (IterableOfFutureOfNull = dart.constFn(core.Iterable$(FutureOfNull())))();
  ...
  dart.defineLazy(src__utils, {
    /*src__utils.lineSplitter*/get lineSplitter() {
      return StreamTransformerOfListOfint$String().new(dart.fn((stream, cancelOnError) => StreamOfString()._check(StreamOfString()._check(stream.transform(core.String, convert.utf8.decoder)).transform(core.String, const$1 || (const$1 = dart.const(new convert.LineSplitter.new())))).listen(null, {cancelOnError: cancelOnError}), StreamOfListOfintAndboolToStreamSubscriptionOfString()));
    },
  ...
  src__utils.inCompletionOrder = function(T, operations) {
    ...
    let controller = async$.StreamController$(T).new({sync: true, onCancel: dart.fn(() => async$.Future.wait(dart.dynamic, IterableOfFuture()._check(operationSet.map(async$.Future, dart.fn(operation => operation.cancel(), dart.fnType(async$.Future, [src__cancelable_operation.CancelableOperation$(T)]))))), VoidToFutureOfList())});
  ...
  src__utils.bullet = function(strings) {
    return IterableOfString()._check(strings[$map](core.String, dart.fn(src__utils.addBullet, StringToString())))[$join]("\n");
  };
  ...
  dart.defineLazy(src__backend__platform_selector, {
    /*src__backend__platform_selector._universalValidVariables*/get _universalValidVariables() {
      ...
      _.addAll(IterableOfString()._check(src__backend__runtime.Runtime.builtIn[$map](core.String, dart.fn(runtime => runtime.identifier, RuntimeToString()))));
      _.addAll(IterableOfString()._check(src__backend__operating_system.OperatingSystem.all[$map](core.String, dart.fn(os => os.identifier, OperatingSystemToString()))));
      return _;
    }
  });
  ...
  src__backend__metadata.Metadata = class Metadata extends core.Object {
    ...
    static new(opts) {
      ...
      let merged = src__backend__metadata.Metadata._check(forTag[$keys][$toList]()[$fold](src__backend__metadata.Metadata, empty, dart.fn((merged, selector) => {
    ...
    [_validateTags]() {
      let invalidTags = IterableOfString()._check(this.tags.where(dart.fn(tag => !tag[$contains](src__utils.anchoredHyphenatedIdentifier), StringTobool()))[$map](core.String, dart.fn(tag => "\"" + dart.str(tag) + "\"", StringToString())))[$toList]();
  ...
  (src__backend__metadata.Metadata.deserialize = function(serialized) {
    ...
    this[forTag$] = MapOfBooleanSelector$Metadata()._check(core.Map.as(dart.dindex(serialized, "forTag"))[$map](boolean_selector$.BooleanSelector, src__backend__metadata.Metadata, dart.fn((key, nested) => MapEntryOfBooleanSelector$Metadata().new(boolean_selector$.BooleanSelector.parse(core.String.as(key)), new src__backend__metadata.Metadata.deserialize(nested)), dynamicAnddynamicToMapEntryOfBooleanSelector$Metadata())));
  }).prototype = src__backend__metadata.Metadata.prototype;
  ...
  src__backend__group.Group = class Group extends core.Object {
    ...
    [_map](callback) {
      return IterableOfGroupEntry()._check(this.entries[$map](src__backend__group_entry.GroupEntry, dart.fn(entry => callback(entry), GroupEntryToGroupEntry())))[$where](dart.fn(entry => entry != null, GroupEntryTobool()))[$toList]();
    }
  };
  ...
  src__frontend__async_matcher.AsyncMatcher = class AsyncMatcher extends src__interfaces.Matcher {
    matches(item, matchState) {
      ...
      if (async$.Future.is(result)) {
        ...
        FutureOfNull()._check(result.then(core.Null, dart.fn(realResult => {
          if (realResult != null) {
  ...
  src__frontend__expect._expect = function(actual, matcher, opts) {
    ...
    if (src__frontend__async_matcher.AsyncMatcher.is(matcher)) {
      ...
      if (typeof result == 'string') {
        ...
        src__backend__invoker.Invoker.current.addOutstandingCallback();
        return FutureOfNull()._check(result.then(core.Null, dart.fn(realResult => {
  ...
  dart.copyProperties(src__frontend__never_called, {
    get neverCalled() {
      ...
      return dart.fn((a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) => {
        ...
        zone.handleUncaughtError(new src__frontend__expect.TestFailure.new("Callback should never have been called, but it was called with" + (dart.test(arguments$[$isEmpty]) ? " no arguments." : ":\n" + dart.str(src__utils.bullet(IterableOfString()._check(arguments$[$map](core.String, dart.fn(src__utils.prettyPrint, dynamicToString()))))))), zone.run(core.StackTrace, dart.fn(() => src__chain.Chain.current(), VoidToChain())));
        return null;
      }, __ToNull());
    }
  });
  ...
  src__frontend__prints_matcher._Prints = class _Prints extends src__frontend__async_matcher.AsyncMatcher {
    matchAsync(item) {
      ...
      return async$.Future.is(result) ? FutureOfString()._check(result.then(core.String, dart.fn(_ => this[_check](buffer.toString()), dynamicToString()))) : this[_check](buffer.toString());
    }
    describe(description) {
  ...
  src__frontend__stream_matcher._StreamMatcher = class _StreamMatcher extends src__frontend__async_matcher.AsyncMatcher {
    ...
    matchAsync(item) {
      ...
      return FutureOfString()._check(this.matchQueue(copy).then(core.String, dart.fn(result => async$.async(core.String, function*() {
        if (result == null) {
        ...
        let eventsString = IterableOfString()._check(events[$map](core.String, dart.fn(event => {
          if (event == null) {
  ...
  src__frontend__throws_matcher.Throws = class Throws extends src__frontend__async_matcher.AsyncMatcher {
    matchAsync(item) {
      ...
      if (async$.Future.is(item)) {
        return FutureOfString()._check(item.then(core.String, dart.fn(value => src__utils.indent(src__utils.prettyPrint(value), {first: "emitted "}), dynamicToString()), {onError: dart.bind(this, _check$)}));
      }
      try {
        let value = dart.dcall(item, []);
        if (async$.Future.is(value)) {
          return FutureOfString()._check(value.then(core.String, dart.fn(value => src__utils.indent(src__utils.prettyPrint(value), {first: "returned a Future that emitted "}), dynamicToString()), {onError: dart.bind(this, _check$)}));
        }
  ...
  src__frontend__stream_matchers.emitsAnyOf = function(matchers) {
    let streamMatchers = IterableOfStreamMatcher()._check(matchers[$map](src__frontend__stream_matcher.StreamMatcher, dart.fn(src__frontend__stream_matchers.emits, dynamicToStreamMatcher())))[$toList]();
    ...
    let description = "do one of the following:\n" + dart.notNull(src__utils.bullet(IterableOfString()._check(streamMatchers[$map](core.String, dart.fn(matcher => matcher.description, StreamMatcherToString())))));
    return src__frontend__stream_matcher.StreamMatcher.new(dart.fn(queue => async$.async(core.String, function*() {
      let transaction = queue.startTransaction();
  ...
  src__frontend__stream_matchers.emitsInAnyOrder = function(matchers) {
    let streamMatchers = IterableOfStreamMatcher()._check(matchers[$map](src__frontend__stream_matcher.StreamMatcher, dart.fn(src__frontend__stream_matchers.emits, dynamicToStreamMatcher())))[$toSet]();
    if (streamMatchers.length === 1) return streamMatchers.first;
  ...
  src__frontend__stream_matchers._tryInAnyOrder = function(queue, matchers) {
    return async$.async(core.bool, function* _tryInAnyOrder() {
      ...
      let firstError = null;
      let firstStackTrace = null;
      yield async$.Future.wait(core.Null, IterableOfFutureOfNull()._check(matchers.map(FutureOfNull(), dart.fn(matcher => async$.async(core.Null, function*() {
        let copy = transaction.newQueue();
        try {
