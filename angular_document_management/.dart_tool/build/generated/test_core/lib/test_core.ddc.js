define(['dart_sdk', 'packages/test_api/test_api', 'packages/path/path', 'packages/stack_trace/stack_trace', 'packages/stream_channel/stream_channel', 'packages/pool/pool', 'packages/async/async', 'packages/collection/collection', 'packages/collection/src/canonicalized_map', 'packages/test_api/src/util/iterable_set', 'packages/source_span/source_span', 'packages/boolean_selector/boolean_selector'], function(dart_sdk, test_api, path, stack_trace, stream_channel, pool, async, collection, canonicalized_map, iterable_set, source_span, boolean_selector) {
  ...
  src__runner__load_suite.LoadSuite = class LoadSuite extends src__backend__suite.Suite {
    ...
    static new(name, config, platform, body, opts) {
      ...
      return new src__runner__load_suite.LoadSuite.__(name, config, platform, dart.fn(() => {
        ...
        FutureOfNull()._check(invoker.liveTest.onComplete.then(core.Null, dart.fn(_ => {
    ...
    changeSuite(change) {
      return new src__runner__load_suite.LoadSuite._changeSuite(this, FutureOfPairOfRunnerSuite$Zone()._check(this[_suiteAndZone].then(PairOfRunnerSuite$Zone(), dart.fn(pair => {
  ...
  src__runner__engine.Engine = class Engine extends core.Object {
    ...
    [_addLoadSuite](suite) {
      return async$.async(src__runner__live_suite_controller.LiveSuiteController, (function* _addLoadSuite() {
        ...
        FutureOfNull()._check(innerController.liveSuite.onClose.then(core.Null, dart.fn(_ => {
          liveTest.close();
          controller.close();
        }, dynamicToNull())));
    ...
    close() {
      return async$.async(dart.dynamic, (function* close() {
        ...
        let futures = IterableOfFuture()._check(allLiveTests.map(async$.Future, dart.fn(liveTest => liveTest.close(), LiveTestToFuture())))[$toList]();
  ...
  (src__runner__engine.Engine.new = function(opts) {
    ...
    FutureOfNull()._check(this[_group].future.then(core.Null, dart.fn(_ => {
  ...
  src__runner__suite.SuiteConfiguration = class SuiteConfiguration extends core.Object {
    ...
    get metadata() {
      ...
      return this[_metadata].change({forTag: MapOfBooleanSelector$Metadata()._check(this.tags[$map](boolean_selector$.BooleanSelector, src__backend__metadata.Metadata, dart.fn((key, config) => MapEntryOfBooleanSelector$Metadata().new(key, config.metadata), BooleanSelectorAndSuiteConfigurationToMapEntryOfBooleanSelector$Metadata()))), onPlatform: MapOfPlatformSelector$Metadata()._check(this.onPlatform[$map](src__backend__platform_selector.PlatformSelector, src__backend__metadata.Metadata, dart.fn((key, config) => MapEntryOfPlatformSelector$Metadata().new(key, config.metadata), PlatformSelectorAndSuiteConfigurationToMapEntryOfPlatformSelector$Metadata())))});
    }
    get knownTags() {
    ...
    static fromMetadata(metadata) {
      return new src__runner__suite.SuiteConfiguration.__({tags: MapOfBooleanSelector$SuiteConfiguration()._check(metadata.forTag[$map](boolean_selector$.BooleanSelector, src__runner__suite.SuiteConfiguration, dart.fn((key, child) => MapEntryOfBooleanSelector$SuiteConfiguration().new(key, src__runner__suite.SuiteConfiguration.fromMetadata(child)), BooleanSelectorAndMetadataToMapEntryOfBooleanSelector$SuiteConfiguration()))), onPlatform: MapOfPlatformSelector$SuiteConfiguration()._check(metadata.onPlatform[$map](src__backend__platform_selector.PlatformSelector, src__runner__suite.SuiteConfiguration, dart.fn((key, child) => MapEntryOfPlatformSelector$SuiteConfiguration().new(key, src__runner__suite.SuiteConfiguration.fromMetadata(child)), PlatformSelectorAndMetadataToMapEntryOfPlatformSelector$SuiteConfiguration()))), metadata: metadata.change({forTag: new (LinkedMapOfBooleanSelector$Metadata()).new(), onPlatform: new (LinkedMapOfPlatformSelector$Metadata()).new()})});
    }
    ...
    validateRuntimes(allRuntimes) {
      let validVariables = IterableOfString()._check(allRuntimes[$map](core.String, dart.fn(runtime => runtime.identifier, RuntimeToString())))[$toSet]();
    ...
    [_resolveTags]() {
      ...
      let merged = src__runner__suite.SuiteConfiguration._check(this.tags[$keys][$fold](src__runner__suite.SuiteConfiguration, src__runner__suite.SuiteConfiguration.empty, dart.fn((merged, selector) => {
  ...
  (src__runner__runner_suite.RunnerSuiteController.new = function(environment, config, suiteChannel, groupFuture, platform, opts) {
    ...
    this[_suite] = FutureOfRunnerSuite()._check(groupFuture.then(src__runner__runner_suite.RunnerSuite, dart.fn(group => new src__runner__runner_suite.RunnerSuite.__(this, group, path, platform), GroupToRunnerSuite())));
  ...
  (src__runner__live_suite_controller.LiveSuiteController.new = function(suite) {
    ...
    FutureOfNull()._check(this[_onCompleteGroup].future.then(core.Null, dart.fn(_ => {
